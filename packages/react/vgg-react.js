...
var gr = Object.defineProperty, pr = (u, t, a) => t in u ? gr(u, t, { enumerable: !0, configurable: !0, writable: !0, value: a }) : u[t] = a, m = (u, t, a) => (pr(u, typeof t != "symbol" ? t + "" : t, a), a), k = /* @__PURE__ */ ((u) => (u.Load = "load", u.LoadError = "loaderror", u.StateChange = "statechange", u.Click = "click", u))(k || {}), T = /* @__PURE__ */ ((u) => (u.Loading = "loading", u.Ready = "ready", u.Error = "error", u))(T || {});
class mr {
  constructor(t = []) {
    this.listeners = t;
  }
   ...
   */
  removeAll(t) {
    t ? this.listeners.filter((a) => a.type === t).forEach((a) => this.remove(a)) : this.listeners.splice(0, this.listeners.length);
  }
  // Fires an event
  fire(t, a) {
...
const br = (u = 21) => crypto.getRandomValues(new Uint8Array(u)).reduce(
  (t, a) => t += (a &= 63) < 36 ? a.toString(36) : a < 62 ? (a - 26).toString(36).toUpperCase() : a > 62 ? "-" : "_",
  ""
);
class yr {
  constructor(t, a) {
    m(this, "selector"), m(this, "vggSdk"), this.selector = t, this.vggSdk = a;
  }
  on(t, a) {
  ...
  addEventListener(t, a, l) {
    if (!this.vggSdk)
      throw new Error("VGG SDK not ready");
    const h = (y) => l(this, y), d = br(7), b = `export default (event, opts) => {
...
const je = class Fe {
  ...
  constructor(t) {
    m(this, "props"), m(this, "defaultRuntime", "https://s5.vgg.cool/runtime/latest"), m(this, "canvas"), m(this, "width", 0), m(this, "height", 0), m(this, "editMode", !1), m(this, "verbose"), m(this, "src"), m(this, "runtime"), m(this, "vggInstanceKey", ""), m(this, "eventManager"), m(this, "state", T.Loading), m(this, "vggWasmInstance", null), m(this, "vggSdk", null), m(this, "observables", /* @__PURE__ */ new Map()), m(this, "requestAnimationFrame"), m(this, "logger");
    var a, l;
    this.props = t, this.canvas = t.canvas, this.src = t.src, this.runtime = t.runtime || this.defaultRuntime, this.width = ((a = this.canvas) == null ? void 0 : a.width) ?? 0, this.height = ((l = this.canvas) == null ? void 0 : l.height) ?? 0, this.editMode = t.editMode ?? !1, this.verbose = t.verbose ?? !1, this.logger = new Er(this.verbose), this.eventManager = new mr(), t.onLoad && this.on(k.Load, t.onLoad), t.onLoadError && this.on(k.LoadError, t.onLoadError), t.onStateChange && this.on(k.StateChange, t.onStateChange), t.onSelect && this.on(k.Click, t.onSelect);
  }
  async load() {
    try {
  ...
  async init({ src: t }) {
    if (this.src = t, this.insertScript(this.runtime + "/vgg_runtime.js"), !this.canvas)
  ...
  async checkState(t) {
    ...
    if (window._vgg_createWasmInstance) {
      ...
      if (l) {
        ...
        this.vggInstanceKey = this.vggSdk.getEnv(), this.editMode ? Object.assign(h, {
          [this.vggInstanceKey]: {
            instance: l,
            listener: (d) => {
              var b;
              const v = JSON.parse(d);
              this.verbose && this.logger.logEvent(v), v.type === "select" && ((b = this.observables.get(v.path)) == null || b.next("click"), this.eventManager.fire({
                type: k.Click,
                data: v
              }));
            }
        ...
        }), globalThis.vggInstances = h, this.state = T.Ready, this.eventManager.fire({ type: k.Load });
      } else
   ...
   */
  async render(t, a) {
    if (this.width = (a == null ? void 0 : a.width) ?? this.width, this.height = (a == null ? void 0 : a.height) ?? this.height, this.editMode = (a == null ? void 0 : a.editMode) ?? this.editMode, !this.vggWasmInstance)
      throw new Error("VGG Wasm instance not ready");
    const l = await fetch(t ?? this.src);
    if (!l.ok)
      throw new Error("Failed to fetch Daruma file");
    const h = await l.arrayBuffer(), d = new Int8Array(h);
...
function kr(u) {
  const { src: t, runtime: a, ...l } = u, h = Q(null), d = Q(null), [b, v] = hr(T.Loading);
  return xe(() => {
    h.current && (async () => (d.current = new re({
      src: t,
      runtime: a ?? "https://s5.vgg.cool/runtime/latest",
      canvas: h.current,
      ...l
    }), await d.current.load(), d.current.state === T.Ready ? (await d.current.render(), v(T.Ready)) : v(T.Error)))();
  }, []), {
    canvasRef: h,
    vgg: d,
...
function Rr() {
  return Ce || (Ce = 1, process.env.NODE_ENV !== "production" && function() {
    var u = Pe, t = Symbol.for("react.element"), a = Symbol.for("react.portal"), l = Symbol.for("react.fragment"), h = Symbol.for("react.strict_mode"), d = Symbol.for("react.profiler"), b = Symbol.for("react.provider"), v = Symbol.for("react.context"), y = Symbol.for("react.forward_ref"), P = Symbol.for("react.suspense"), E = Symbol.for("react.suspense_list"), w = Symbol.for("react.memo"), x = Symbol.for("react.lazy"), $ = Symbol.for("react.offscreen"), te = Symbol.iterator, Ie = "@@iterator";
    function Ae(e) {
    ...
    var Le = !1, Me = !1, We = !1, $e = !1, Ve = !1, ne;
    ne = Symbol.for("react.module.reference");
    function Ge(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === l || e === d || Ve || e === h || e === P || e === E || $e || e === $ || Le || Me || We || typeof e == "object" && e !== null && (e.$$typeof === x || e.$$typeof === w || e.$$typeof === b || e.$$typeof === v || e.$$typeof === y || // This needs to include all possible module reference object
    ...
    var j = Object.assign, D = 0, ie, se, oe, le, ce, ue, fe;
    function de() {
    }
    ...
    function Ne() {
      {
        if (D === 0) {
          ie = console.log, se = console.info, oe = console.warn, le = console.error, ce = console.group, ue = console.groupCollapsed, fe = console.groupEnd;
          var e = {
            configurable: !0,
            enumerable: !0,
            value: de,
...
`), _ = i.stack.split(`
`), g = s.length - 1, p = _.length - 1; g >= 1 && p >= 0 && s[g] !== _[p]; )
            p--;
          for (; g >= 1 && p >= 0; g--, p--)
            if (s[g] !== _[p]) {
              if (g !== 1 || p !== 1)
...
` + s[g].replace(" at new ", " at ");
    ...
    var N = Object.prototype.hasOwnProperty, he = {}, ge = F.ReactDebugCurrentFrame;
    function U(e) {
      if (e) {
    ...
    function Je(e, r, n, i, c) {
      {
        ...
        for (var o in e)
          if (f(e, o)) {
            ...
            s && !(s instanceof Error) && (U(c), R("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", i || "React class", n, o, typeof s), U(null)), s instanceof Error && !(s.message in he) && (he[s.message] = !0, U(c), R("Failed %s type: %s", n, s.message), U(null));
          }
      }
    }
    ...
    function me(e) {
      if (Xe(e))
        return R("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", He(e)), pe(e);
    }
    var L = F.ReactCurrentOwner, Ze = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function ir(e, r, n, i, c) {
      {
        ...
        n !== void 0 && (me(n), s = "" + n), er(r) && (me(r.key), s = "" + r.key), Qe(r) && (_ = r.ref, rr(r, c));
        for (f in r)
    ...
    function we(e, r) {
      {
        ...
        _e[n] = !0;
        var i = "";
        e && e._owner && e._owner !== H.current && (i = " It was passed a child from " + C(e._owner.type) + "."), I(e), R('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', n, i), I(null);
      }
    }
    function Se(e, r) {
      {
...
function _r() {
  if (Oe)
    return W;
  Oe = 1;
  var u = Pe, t = Symbol.for("react.element"), a = Symbol.for("react.fragment"), l = Object.prototype.hasOwnProperty, h = u.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, d = { key: !0, ref: !0, __self: !0, __source: !0 };
  function b(v, y, P) {
    var E, w = {}, x = null, $ = null;
    P !== void 0 && (x = "" + P), y.key !== void 0 && (x = "" + y.key), y.ref !== void 0 && ($ = y.ref);
    for (E in y)
      l.call(y, E) && !d.hasOwnProperty(E) && (w[E] = y[E]);
    if (v && v.defaultProps)
      for (E in y = v.defaultProps, y)
        w[E] === void 0 && (w[E] = y[E]);
    return { $$typeof: t, type: v, key: x, ref: $, props: w, _owner: h.current };
  }
  return W.Fragment = a, W.jsx = b, W.jsxs = b, W;
}
process.env.NODE_ENV === "production" ? ee.exports = _r() : ee.exports = Rr();
var wr = ee.exports;
function Tr(u) {
  const {
    src: t,
  ...
  return xe(() => {
    E.current && (async () => {
      ...
      await w.load(), w.state === T.Ready ? (await w.render(), b == null || b(
        {
          type: k.Load,
          data: ""
        },
